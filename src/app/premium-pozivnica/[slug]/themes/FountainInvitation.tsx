...
// Fountain sprite metrics. Current asset is a 4-frame horizontal strip
// chroma-keyed from a 2x2 green-screen source grid, union-bbox cropped,
// downscaled to 480px tall + 8px transparent pad, and PNG-8 quantized
// to 192 colors. Sheet 1944x496, ~174 KB. Cell 486x496.
const FOUNTAIN_FRAMES = 4;
const FOUNTAIN_CELL_W = 486;
const FOUNTAIN_CELL_H = 496;
// 0.6s / 4 frames = 150ms per frame. Slightly longer hold per frame
// than the 8-frame setup (100ms) because with fewer frames the eye has
// more time to register each phase — still short enough that the
// discrete steps integrate into smooth-looking motion.
const FOUNTAIN_DURATION_S = 0.6;
