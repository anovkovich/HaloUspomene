...
export const alt = "Pozivnica za prvi rođendan — online | HALO Uspomene";
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
              ...
              />
              <span style={{ fontSize: 22, color: "#AE343F", opacity: 0.6 }}>
                🎂
              </span>
              <div
                style={{ width: 60, height: 1, background: "#AE343F", opacity: 0.3 }}
            ...
            >
              Šarena digitalna pozivnica za prvu godinu
            </span>
