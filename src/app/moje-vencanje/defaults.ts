...
export function getDefaultChecklist(): ChecklistItem[] {
  ...
  return [
    ...items("12+", [
      "Odrediti ukupan budžet i podeliti ga po kategorijama",
    ...
    ...items("9-12", [
      ...
      "Rezervisati muziku (bend ili DJ)",
      "Rezervisati dekoratera i cvećaru",
    ...
    ...items("6-9", [
      ...
      "Dogovoriti meni i naručiti tortu (degustacija)",
    ...
    ...items("3-6", [
      "Kupiti burme",
      "Naručiti pozivnice",
      "Srediti dokumentaciju za matičara / crkvu",
      "Proba venčanice i odela",
      "Organizovati prevoz (mladenci i gosti)",
      "Odabrati poklone za goste",
    ]),
    ...items("1-3", [
      "Poslati pozivnice",
      "Pratiti RSVP prijave",
      "Napraviti raspored sedenja",
      "Napraviti satnicu dana",
