...
export const VENDORS: Vendor[] = [
  // ── Venues: Beograd (13) ──
  { id: "v-beolido", name: "Beolido Event Centar", category: "venue", city: "Beograd", phone: "+381 69 1090910", website: "beolido.rs", instagram: "@beolidorivereventclub" },
  { id: "v-event-s", name: "Event Centar S", category: "venue", city: "Beograd", website: "eventcentars.rs", instagram: "@event.centar.s" },
  { id: "v-azzaro-black", name: "Azzaro Black Club", category: "venue", city: "Beograd", website: "azzaroclub.rs", instagram: "@azzaroclubs" },
  { id: "v-azzaro-white", name: "Azzaro White Club", category: "venue", city: "Beograd", website: "azzaroclub.rs", instagram: "@azzaroclubs" },
  { id: "v-azzaro-red", name: "Azzaro RED Club", category: "venue", city: "Beograd", website: "azzaroclub.rs", instagram: "@azzaroclubs" },
  { id: "v-belgrade-hills", name: "Belgrade Hills Villa", category: "venue", city: "Beograd", phone: "+381 11 299 20 24", website: "belgradehill.rs", instagram: "@thebelgradehills" },
  { id: "v-sest-topola", name: "Restoran Šest Topola", category: "venue", city: "Beograd", phone: "+381 61 30 20 300", website: "sesttopola.rs", instagram: "@sest_topola" },
  { id: "v-imperium", name: "Imperium Hall", category: "venue", city: "Beograd", phone: "063/300-558", website: "imperiumhall.rs", instagram: "@imperium.hall" },
  { id: "v-stadion", name: "Restoran Stadion", category: "venue", city: "Beograd", phone: "+381 62 212112", website: "restoranstadion.com", instagram: "@restoranstadion" },
  { id: "v-filmski-grad", name: "Filmski Grad", category: "venue", city: "Beograd", phone: "+381 11 3559 180", website: "filmskigrad.rs", instagram: "@filmski_grad_filmska_zvezda" },
  { id: "v-cotier", name: "Cotier", category: "venue", city: "Beograd", phone: "+381 69 688988", website: "cotier.rs", instagram: "@cotier.events" },
  { id: "v-glamoure", name: "Glamoure Event Center", category: "venue", city: "Beograd", phone: "+381 65 3330085", website: "glamoure.rs", instagram: "@glamoure_event_center" },
  { id: "v-fors", name: "Restoran ForS", category: "venue", city: "Beograd", website: "fors.rs" },
  // ── Venues: Novi Sad (8) ──
  { id: "v-zlatna-dvorana", name: "Zlatna Dvorana", category: "venue", city: "Novi Sad", phone: "+381 64 82 00 600", website: "zlatnadvorana.com", instagram: "@zlatna_dvorana_salazavencanja" },
  { id: "v-villa-palace", name: "Villa Palace", category: "venue", city: "Novi Sad", phone: "+381 21 300 5838", website: "villapalace.org", instagram: "@villapalace" },
  { id: "v-baron-castel", name: "Baron Castel", category: "venue", city: "Novi Sad", phone: "+381 63 416 216", website: "baron.rs", instagram: "@baronfashion_wedding" },
  { id: "v-exclusive-ns", name: "Exclusive NS", category: "venue", city: "Novi Sad", phone: "+381 63 10 17 017", website: "exclusivens.com", instagram: "@ekskluzivns" },
  { id: "v-dva-galeba", name: "Dva Galeba", category: "venue", city: "Novi Sad", phone: "065/5257700", website: "dvagaleba.com", instagram: "@dva_galeba" },
  { id: "v-markovi-konaci", name: "Etno selo Markovi Konaci", category: "venue", city: "Novi Sad", phone: "063222483", website: "etnoselomarkovikonaci.rs", instagram: "@markovikonaci" },
  { id: "v-salas-137", name: "Salaš 137", category: "venue", city: "Novi Sad", phone: "+381 62 773 137", website: "salas137.rs", instagram: "@salas137" },
  { id: "v-petlov-salas", name: "Petlov Salaš", category: "venue", city: "Novi Sad", phone: "+381 66 364664", website: "petlovsalas.rs", instagram: "@restoran_petlov_salas" },
  // ── Venues: Subotica (8) ──
  { id: "v-zvonko-bogdan", name: "Vinarija Zvonko Bogdan", category: "venue", city: "Subotica", phone: "+381 66 633 0333", website: "vinarijazvonkobogdan.com", instagram: "@salaszvonkobogdan" },
  { id: "v-sala-zorica", name: "Sala Zorica", category: "venue", city: "Subotica", phone: "+381 64 416 6530", website: "salazorica.rs", instagram: "@salazorica" },
  { id: "v-sala-jelena", name: "Sala Jelena", category: "venue", city: "Subotica", phone: "+381 24 555 397" },
  { id: "v-mirage", name: "Mirage Sala", category: "venue", city: "Subotica", phone: "+381 64 113 3797" },
  { id: "v-salas-101", name: "Salaš 101", category: "venue", city: "Subotica", phone: "060/55-88-451", instagram: "@salas101kelebija" },
  { id: "v-elitte-palic", name: "Elitte Palić", category: "venue", city: "Subotica", phone: "+381 24 753 245", website: "elittepalic.rs", instagram: "@elittepalic" },
  ...
  { id: "v-ergela-kelebija", name: "Ergela Kelebija", category: "venue", city: "Subotica", phone: "+381 24 789 034", website: "ergelakelebija.rs", instagram: "@ergela.kelebija" },
  // ── Venues: Čačak (7) ──
  { id: "v-morava", name: "Restoran Morava", category: "venue", city: "Čačak", phone: "+381 32 333 991", website: "moravacacak.com", instagram: "@moravacacak" },
  { id: "v-royal-residence", name: "Royal Residence", category: "venue", city: "Čačak", phone: "+381 69 363 1330", website: "royalresidence.rs", instagram: "@hotelroyalresidence" },
  { id: "v-habanera", name: "Habanera Luks", category: "venue", city: "Čačak", phone: "064 15 72 383" },
  { id: "v-rajicic", name: "Restoran Rajičić", category: "venue", city: "Čačak", phone: "+381 61 723 0618" },
  { id: "v-radovanje", name: "Radovanje", category: "venue", city: "Čačak", phone: "069 1183009", website: "radovanje.rs", instagram: "@restoran.radovanje" },
  { id: "v-petrovic-ca", name: "Restoran Petrović", category: "venue", city: "Čačak", phone: "032/55-90-333", website: "restoran-petrovic.rs", instagram: "@petrovicrestoran" },
  { id: "v-babic", name: "Ugostiteljski centar Babić", category: "venue", city: "Čačak", phone: "+381 32 365 030", instagram: "@restoran_babic" },
  // ── Venues: Kragujevac (7) ──
  { id: "v-zeneva-lux", name: "Hotel Ženeva Lux", category: "venue", city: "Kragujevac", phone: "+381 34 330 605", website: "zenevalux.com", instagram: "@zeneva_lux" },
  { id: "v-exclusive-kg", name: "Exclusive Event Center", category: "venue", city: "Kragujevac", phone: "+381 63 318 700", website: "exclusive-event.rs", instagram: "@exclusiveeventcenter" },
  { id: "v-sumarice", name: "Hotel Šumarice", category: "venue", city: "Kragujevac", phone: "+381 34 336 449", website: "hotelsumarice.com", instagram: "@hotel_sumarice" },
  ...
  { id: "v-jezero-kg", name: "Restoran Jezero", category: "venue", city: "Kragujevac", phone: "060 610 1920", website: "restoranjezero.rs", instagram: "@restoranjezero.kg" },
  { id: "v-pink-sala", name: "Pink Sala", category: "venue", city: "Kragujevac", phone: "+381 64 660 1345", website: "pinksala.rs" },
  { id: "v-hotel-kg", name: "Hotel Kragujevac", category: "venue", city: "Kragujevac", phone: "+381 34 335-811", website: "hotelkragujevac.com", instagram: "@hotelkragujevackg" },
  // ── Venues: Niš (7) ──
  { id: "v-perla", name: "Restoran Perla", category: "venue", city: "Niš", phone: "063 415 400", website: "perla.rs", instagram: "@restoran_perla" },
  { id: "v-mesecev-konak", name: "Mesečev Konak", category: "venue", city: "Niš", phone: "+381 63 899 0038", website: "mesecevkonak.com", instagram: "@restoran_mesecev_konak" },
  { id: "v-vidikovac", name: "Hotel Vidikovac", category: "venue", city: "Niš", phone: "+381 18 459 1336", website: "hotelvidikovac.rs", instagram: "@vidikovac.hotel" },
  { id: "v-svajcarija", name: "Restoran Švajcarija", category: "venue", city: "Niš", phone: "018/259 999", website: "svajcarija.rs", instagram: "@restoransvajcarija" },
  { id: "v-malca", name: "Vinski Podrum Malča", category: "venue", city: "Niš", phone: "060 601 5747", website: "vinskipodrummalca.com", instagram: "@restoranvinarijemalca" },
  { id: "v-marica", name: "Hotel Marica", category: "venue", city: "Niš", phone: "+381 18 562 333", website: "hotel-marica.com", instagram: "@hotel.restoran.marica" },
  { id: "v-dusanov-konak", name: "Etno restoran Dušanov Konak", category: "venue", city: "Niš", phone: "018 333 44 68", website: "dusanovkonak.com", instagram: "@dusanovkonak2019" },
  // ── Music: Beograd Bendovi (10) ──
  { id: "m-laguna", name: "Laguna Band", category: "music", city: "Beograd", phone: "063 859 0635", website: "lagunabend.com", instagram: "@lagunabend" },
  { id: "m-chegi", name: "CHEGI & Braća Bluz", category: "music", city: "Beograd", phone: "066/418-034", website: "chegi-bend.rs", instagram: "@chegi.music" },
  { id: "m-bajka", name: "Bajka Bend", category: "music", city: "Beograd", phone: "064 271 5391", website: "bajkabend.com", instagram: "@bajkabend" },
  { id: "m-splendid", name: "Splendid Band", category: "music", city: "Beograd", website: "splendidband.com", instagram: "@splendid_music" },
  { id: "m-get-lucky", name: "Get Lucky Band", category: "music", city: "Beograd", phone: "063 84 74 936", website: "getluckyband.net", instagram: "@get_lucky_band" },
  { id: "m-party-time", name: "Party Time Band", category: "music", city: "Beograd", phone: "063 84 74 936", website: "partytimeband.rs" },
  { id: "m-aria", name: "Aria Bend", category: "music", city: "Beograd", phone: "065 558 4465", website: "ariabend.com", instagram: "@aria_bend" },
  { id: "m-republika", name: "Republika Bend", category: "music", city: "Beograd", website: "republikabend.rs", instagram: "@republika_bend_official" },
  { id: "m-showtime", name: "Showtime Bend", category: "music", city: "Beograd", website: "showtimebend.com", instagram: "@showtimebend" },
  { id: "m-slamnig", name: "Nikola Slamnig", category: "music", city: "Beograd", phone: "060 718 7326", website: "muzikazaproslave.in.rs", instagram: "@nikola_slamnig" },
  // ── Music: Beograd DJ (4) ──
  { id: "m-dj-proslave", name: "DJ za Proslave", category: "music", city: "Beograd", phone: "065/440-2070", website: "djzaproslave.rs", instagram: "@djzaproslave" },
  { id: "m-dj-svadbe", name: "DJ Svadbe", category: "music", city: "Beograd", phone: "063/337-993", website: "djsvadbe.rs", instagram: "@djsvadbe" },
  { id: "m-wedding-dj", name: "Wedding DJ", category: "music", city: "Beograd", phone: "062 181 1910", instagram: "@wedding.dj" },
  { id: "m-saxngroove", name: "Sax 'n' Groove", category: "music", city: "Beograd", phone: "060 44 55 820", website: "saxngroove.com", instagram: "@saxngroove_official" },
  // ── Music: Novi Sad Bendovi (9) ──
  { id: "m-mandarina", name: "Mandarina Bend", category: "music", city: "Novi Sad", phone: "063 500 913", website: "mandarinabend.rs", instagram: "@mandarinabend" },
  { id: "m-talasna", name: "Talasna Dužina", category: "music", city: "Novi Sad", phone: "063/349-282", website: "bendtalasnaduzina.com", instagram: "@talasnaduzina" },
  { id: "m-tiktak", name: "Tik Tak Bend", category: "music", city: "Novi Sad", phone: "063 887 9634", website: "bendzasvadbe.rs", instagram: "@tik_tak_bend" },
  { id: "m-pozitiv", name: "Pozitiv Bend", category: "music", city: "Novi Sad", phone: "063 666 556", instagram: "@pozitivbend" },
  { id: "m-kupidon", name: "Kupidon Bend", category: "music", city: "Novi Sad", phone: "063-866-0844", website: "kupidonbend.rs", instagram: "@nikola.djelic_kupidon.bend" },
  { id: "m-simpatico", name: "Simpatico Bend", category: "music", city: "Novi Sad", phone: "060 558 8912", website: "simpaticobend.com", instagram: "@simpaticobend" },
  { id: "m-lila", name: "Lila Bend", category: "music", city: "Novi Sad", phone: "063 500 443", website: "lilabend.com", instagram: "@lilabendnovisad" },
  { id: "m-macak-misa", name: "Mačak Miša", category: "music", city: "Novi Sad", phone: "063 500 443", website: "macakmisa.com", instagram: "@macakmisa_bend" },
  { id: "m-pasadena", name: "Pasadena Bend", category: "music", city: "Novi Sad", phone: "060/13-34-069", website: "pasadenabend.rs", instagram: "@pasadenabend" },
  // ── Music: Novi Sad DJ (2) ──
  { id: "m-ns-party", name: "NS Party Team", category: "music", city: "Novi Sad", phone: "063 120 4169", website: "nspartyteam.com", instagram: "@nspartyteam" },
  { id: "m-dj-bera", name: "DJ Bera", category: "music", city: "Novi Sad", phone: "060 600 2443", website: "djberaa.com", instagram: "@dj_beraa" },
  // ── Music: Subotica (4) ──
  { id: "m-topic", name: "Topic Band", category: "music", city: "Subotica", website: "topicband.rs", instagram: "@topicband" },
  { id: "m-chick-norris", name: "Chick Norris Band", category: "music", city: "Subotica", phone: "060 389 2150" },
  { id: "m-online", name: "Online Band", category: "music", city: "Subotica", phone: "069 277 3140", instagram: "@online.band" },
  { id: "m-ringeraja", name: "Ringeraja Bend", category: "music", city: "Subotica", website: "ringerajabend.rs", instagram: "@ringeraja.rs" },
  // ── Music: Čačak (2) ──
  { id: "m-fenix", name: "Fenix Band", category: "music", city: "Čačak", phone: "065 37 18 370", website: "fenixbandcacak.com", instagram: "@fenixbandcacak_official_" },
  { id: "m-acoustic", name: "Acoustic Band", category: "music", city: "Čačak", phone: "060/383-6192", website: "acousticbandcacak.com", instagram: "@acousticbandcacak" },
  // ── Music: Kragujevac (6) ──
  { id: "m-optimistic", name: "Optimistic Bend", category: "music", city: "Kragujevac", website: "optimisticbend.rs", instagram: "@optimisticbend" },
  { id: "m-tikataka", name: "Tika Taka Bend", category: "music", city: "Kragujevac", phone: "064 070 7027", instagram: "@tikatakabendd" },
  { id: "m-maximus", name: "Maximus Bend", category: "music", city: "Kragujevac", phone: "066 543 3088", instagram: "@maximusbendkg" },
  { id: "m-exclusive-kg", name: "Exclusive Band KG", category: "music", city: "Kragujevac", website: "exclusiveband.net", instagram: "@exclusive_band_kg" },
  { id: "m-alternativa", name: "Grupa Alternativa", category: "music", city: "Kragujevac", website: "grupaalternativa.com", instagram: "@grupaalternativa" },
  { id: "m-saxocrew", name: "SaxoCrew", category: "music", city: "Kragujevac", phone: "066 543 3088", instagram: "@saxocrew_kg" },
  // ── Music: Niš (4) ──
  { id: "m-dolcevita", name: "Dolce Vita Bend", category: "music", city: "Niš", phone: "069 863 0148", website: "dolcevitabend.rs", instagram: "@dolcevitabend" },
  { id: "m-fiesta", name: "Fiesta Bend", category: "music", city: "Niš", instagram: "@fiestabendnis" },
  { id: "m-kameleon", name: "Kameleon Bend", category: "music", city: "Niš", phone: "063 440 880", website: "kameleonbend.com", instagram: "@kameleon_bend" },
  { id: "m-milagro", name: "Bend Milagro", category: "music", city: "Niš", website: "bendmilagro.rs", instagram: "@milagrobendnis" },
  // ── Photo/Video: Beograd (11) ──
  { id: "pv-rudic", name: "Nikola Rudić", category: "photo-video", city: "Beograd", website: "nikolarudic.com" },
  { id: "pv-fototajna", name: "Foto Tajna", category: "photo-video", city: "Beograd", website: "fototajna.com", instagram: "@fototajna_beograd" },
  { id: "pv-randjelovic", name: "Ranđelović Photography", category: "photo-video", city: "Beograd", website: "randjelovicphotography.rs", instagram: "@randjelovicphotography" },
  { id: "pv-matijasevic", name: "Nemanja Matijašević", category: "photo-video", city: "Beograd", website: "nemanjamatijasevic.com", instagram: "@matijasevicphotography" },
  { id: "pv-spomenar", name: "Foto Spomenar", category: "photo-video", city: "Beograd", website: "fotospomenar.com", instagram: "@fotospomenar" },
  { id: "pv-stancic", name: "Mile Stančić", category: "photo-video", city: "Beograd", website: "milestancic.com", instagram: "@mile_stancic" },
  { id: "pv-nikmatic", name: "Nikola Matić", category: "photo-video", city: "Beograd", website: "nikolamatic.rs", instagram: "@nikmatic" },
  { id: "pv-spvideo", name: "SP Video", category: "photo-video", city: "Beograd", website: "spvideo.rs" },
  { id: "pv-boban", name: "Boban Video", category: "photo-video", city: "Beograd", website: "bobanvideo.com" },
  { id: "pv-flymedia", name: "FLY Media", category: "photo-video", city: "Beograd", website: "flymedia.rs", instagram: "@flymedia.inc" },
  { id: "pv-industrija", name: "Industrija Studio", category: "photo-video", city: "Beograd", website: "industrijastudio.rs", instagram: "@industrija.studio" },
  // ── Photo/Video: Novi Sad (6) ──
  { id: "pv-rakic", name: "Dejan Rakić", category: "photo-video", city: "Novi Sad", website: "dejanrakic.com", instagram: "@dejanrakicfot" },
  { id: "pv-rajic", name: "Foto Rajić", category: "photo-video", city: "Novi Sad", website: "fotorajic.com" },
  { id: "pv-bedov", name: "Aleksandar Bedov", category: "photo-video", city: "Novi Sad", website: "abedov.com", instagram: "@aleksandarbedov" },
  { id: "pv-raskovic", name: "Saša Rašković", category: "photo-video", city: "Novi Sad", website: "sasaraskovic.com", instagram: "@sssashaa" },
  { id: "pv-vesic", name: "Monika Vesić", category: "photo-video", city: "Novi Sad", website: "monikavesic.rs", instagram: "@foto_monika" },
  { id: "pv-magic", name: "Magic Moments", category: "photo-video", city: "Novi Sad", website: "magicmoments.rs", instagram: "@magic_moments_content" },
  // ── Photo/Video: Subotica (5) ──
  { id: "pv-danna", name: "Danna Slađana", category: "photo-video", city: "Subotica", website: "dannasladjana.com", instagram: "@dannasladjana" },
  { id: "pv-rafai", name: "Robert Rafai", category: "photo-video", city: "Subotica", website: "robertrafai.com", instagram: "@robertrafai" },
  { id: "pv-vasic", name: "Novica Vasić", category: "photo-video", city: "Subotica", website: "novicavasic.rs", instagram: "@novica.vasic" },
  { id: "pv-sokolovic", name: "Bojan Sokolović", category: "photo-video", city: "Subotica", website: "bojansokolovic.com", instagram: "@bojan_sokolovic" },
  { id: "pv-foto-svadbi-su", name: "Fotografisanje Svadbi SU", category: "photo-video", city: "Subotica", website: "fotografisanjesvadbisubotica.com" },
  // ── Photo/Video: Čačak (2) ──
  { id: "pv-samson", name: "Samson Studio", category: "photo-video", city: "Čačak", website: "samsonmedia.rs", instagram: "@samsonprofilms" },
  { id: "pv-matrix", name: "Studio Matrix", category: "photo-video", city: "Čačak", website: "matrixstudio.rs" },
  // ── Photo/Video: Kragujevac (4) ──
  { id: "pv-iris-kg", name: "IRIS Photo & Video", category: "photo-video", city: "Kragujevac", website: "irisphotoandvideo.rs", instagram: "@irisphoto.art" },
  { id: "pv-art-kg", name: "Photo Studio ART", category: "photo-video", city: "Kragujevac" },
  { id: "pv-ivanovic", name: "Ivanović Photography", category: "photo-video", city: "Kragujevac", website: "ivanovicphotography.com" },
  { id: "pv-creative", name: "Creative Vision", category: "photo-video", city: "Kragujevac", website: "creativevision.rs", instagram: "@creativevisionprodukcija" },
  // ── Photo/Video: Niš (6) ──
  { id: "pv-gojkovic", name: "Jovan Gojković", category: "photo-video", city: "Niš", website: "mywed.com/jovangojkovic", instagram: "@jovan.gojkovic" },
  { id: "pv-mihajlo", name: "Photo by Mihajlo", category: "photo-video", city: "Niš", website: "photobymihajlo.rs", instagram: "@mihajlo.fotograf" },
  { id: "pv-iris-nis", name: "IRIS Photo Studio", category: "photo-video", city: "Niš", website: "irisphotoandvideo.rs" },
  { id: "pv-vuckovic", name: "Pedja Vučković", category: "photo-video", city: "Niš", website: "pedjavuckovic.com", instagram: "@predragvuckovic" },
  { id: "pv-davinci", name: "Da Vinci Studios", category: "photo-video", city: "Niš", website: "davincistudios.rs", instagram: "@da.vinci.studios" },
  { id: "pv-budimir", name: "Foto Video Budimir", category: "photo-video", city: "Niš", website: "fotobudimir.com" },
  // ── Cakes: Beograd (5) ──
