      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-6xl mx-auto">
          {packages.map((pkg) => (
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-4 sm:-top-5 md:-top-6 left-1/2 -translate-x-1/2 bg-[#AE343F] text-[#F5F4DC] px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-full text-xs font-bold uppercase tracking-widest">
                  Najtraženije
                </div>
              )}
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-serif text-[#232323] mb-6 sm:mb-8">{pkg.name}</h3>
