...
- [in-progress] 2026-08-03 **Prijem gostiju na vratima (hostesa)** — `/gde-sedim/?h={checkin_token}` prebacuje gostinsku pretragu u režim hostese (štiklira dolazak, ne vidi portal ni PIN); feature zatečen iz ranije sesije i sada prvi put zaveden, uz UX popravku „broj gostiju se bira PRE potvrde" + dugme „Stigli"; čeka probu na terenu + deploy → `docs/dev-log/2026-08-03-hostesa-prijem-gostiju/`
